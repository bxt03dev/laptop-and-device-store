    ...
    <div class="container px-0">
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
            ...
            <button class="navbar-toggler py-2 px-3" type="button" data-bs-toggle="collapse"
                ...
                <span class="fa fa-bars primary_color"></span>
            </button>
            <div class="collapse navbar-collapse bg-white justify-content-between mx-5" id="navbarCollapse">
                ...
                <div class="d-flex m-3 me-0">
                    <button
                            ...
                            class="fas fa-search primary_color"></i></button>
                    <c:if test="${pageContext.request.userPrincipal != null}">
                        <a href="/cart" class="position-relative me-4 my-auto">
                                <i class="fa fa-shopping-bag fa-2x" style="color: #ff5b00"></i>
                        ...
                        <div class="dropdown my-auto">
                                <a href="#" class="dropdown" role="button" id="dropdownMenuLink"
                                   ...
                                   aria-expanded="false">
                                    <i class="fas fa-user fa-2x" style="color: #ff5b00"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end p-4" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <li>
                                        <form method="post" action="/logout">
                                            ...
                                            <button class="dropdown-item" style="color: #f6412d;">Log out</button>
                                        </form>
                                    </li>
                                </ul>
                            </div>
